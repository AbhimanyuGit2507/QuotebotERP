...
export class UpdateProcessingSettingsDto {
  @ApiPropertyOptional({
    description: 'Worker interval in milliseconds',
    example: 20000,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Maximum messages processed in one worker run',
    example: 60,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Maximum bytes per classifier batch',
    example: 26000,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Delay between extraction calls in milliseconds',
    example: 50,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'LLM calls allowed per minute',
    example: 10,
  })
  @IsOptional()
  @IsInt()
