...
async function main() {
    ...
    try {
        ...
        const parsedNonRfq = processedMessages.find((m) => m.external_id?.endsWith('1'));
        ...
        if (parsedNonRfq) {
            const payload = (parsedNonRfq.raw_payload || {});
        ...
        if (parsedRfq) {
            const payload = (parsedRfq.raw_payload || {});
...
//# sourceMappingURL=test-email-rfq-pipeline.js.map