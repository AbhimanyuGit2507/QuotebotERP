...
const record_payment_dto_1 = require("./dtos/record-payment.dto");
let PaymentsController = class PaymentsController {
    paymentsService;
    constructor(paymentsService) {
        this.paymentsService = paymentsService;
    }
    recordPayment(user, dto) {
        return this.paymentsService.recordPayment(user.tenant_id, dto);
    }
    findAll(user, page, pageSize, sortBy, sortOrder) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, record_payment_dto_1.RecordPaymentDto]),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PaymentsController.prototype, "getReceivablesAging", null);
__decorate([
