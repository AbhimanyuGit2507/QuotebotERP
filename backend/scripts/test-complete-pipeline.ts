/**
 * Complete System Pipeline Test
 * Tests: RFQ Email → Parse → Quotation → Send → PO → Invoice
 */
...
class PipelineTester {
  ...
  private async testEmailIngestion() {
  ...
  private async testQuotationGeneration() {
    ...
    try {
      ...
      // Check if quotations were auto-generated
  ...
  private async testQuotationEmail() {
  ...
  private async testPOProcessing() {
  ...
  private async testFollowupHandling() {
  ...
  private async apiCall(method: string, endpoint: string, options: any = {}) {
    return axios({
      method,
