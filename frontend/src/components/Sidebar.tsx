...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`app-sidebar ${isExpanded ? 'w-56' : 'w-[56px]'} bg-gradient-to-b from-[var(--erp-primary)] via-[var(--erp-sidebar-bg)] to-[rgba(0,52,89,0.92)] text-white flex flex-col shrink-0 transition-all duration-300 font-sans relative z-40`}
    >
